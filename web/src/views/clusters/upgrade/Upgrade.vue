...
<template>
  <el-scrollbar height="calc(100vh - 220px)">
    ...
    <CompareVersion v-else :cluster="cluster" :version="version"></CompareVersion>
    <ChooseNewResourcePackage ref="choose" :cluster="cluster"></ChooseNewResourcePackage>
  </el-scrollbar>
</template>
...
export default {
  ...
  components: { CompareVersion, ChooseNewResourcePackage },
  mounted () {
