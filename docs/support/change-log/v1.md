...
webterminal to nodes:
  * https://gist.github.com/apparentlymart/b4ef5854d0c5ca06d9674715259a95f0
...
docker run -d \
  ...
  eipwork/kuboard-spray:v1.0.0-beta.1-amd64
  # 如果您是 arm64 环境，请将标签里的 amd64 修改为 arm64，例如 eipwork/kuboard-spray:latest-arm64
  # 如果抓不到这个镜像，可以尝试一下这个备用地址：
  # swr.cn-east-2.myhuaweicloud.com/kuboard/kuboard-spray:v1.0.0-beta.1-amd64
```
...
**优化**
* 集群状态显示列表中，展示节点是否处于暂停调度的状态【待处理】

**问题修正**
* 部分情况下，不能执行 CIS 扫描的问题【待处理】 -->
